...
<html>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <table align = "center" >
            ...
            <td> <textarea name="address" rows="4" cols="40" placeholder="house no./road no./block no./section no./district/Bangladesh."></textarea><?php echo $validationaddress; ?></td>
            </tr>
            <td>Permanent Address :</td>
            <td> <textarea name="address1" rows="4" cols="40" placeholder="house no./road no./block no./section no./district/Bangladesh."></textarea><?php echo $validationaddress1; ?></td>
            </tr>
